...
class Snail():
    def __init__(self, pos, bounding_rect, images_left, images_right, camera, image=None, speed=3):
        self.state = LEFT
        self.pos = pos
    ...
    def draw(self, screen):
        ...
        if self.state == LEFT:
            screen.blit(self.animation_left.image, (int(self.pos[0]-self.rect[2]/2),int(self.pos[1]-self.rect[3]/2)))
        else:
            screen.blit(self.animation_right.image, (int(self.pos[0]-self.rect[2]/2),int(self.pos[1]-self.rect[3]/2)))
