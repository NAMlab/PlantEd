...
class Watering_can:
    def __init__(self, pos, amount=0, rate=0.15, cost=1): # take from config
        self.pos = pos
    ...
    def activate(self, pos=None, amount=None):
        self.amount = self.default_amount if amount is None else amount
        self.pos = pos if pos else (0,0)
        self.active = True
        pygame.mouse.set_visible(False)
        self.can_particle_system.spawn_box = Rect(pos[0], pos[1] + 100, 0, 0)
