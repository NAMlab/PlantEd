...
class Log():
    def __init__(self):
        ...
        self.model_writer.writerow(["Time", "", "", "Percentage Sliders", "","","","","Intake", "Mikromol/Second", "", "", "Masses", "gramm DW",
                                    "", "", "Pools", "Mikromol", "", "Rates",
                                    "MirkoMol/Second", "", ""])
        self.model_writer.writerow(["Days", "Hours", "Minutes", "Leaf_percentage", " Stem_percentage", "Root_percentage", "Starch_percentage", "Seed_percentage" ,"Water_in", "Nitrate_in", "Starch_in", "Photon_in", "Leaf_mass", "Stem_mass",
    ...
    def append_model_row(self, days, hours, minutes, leaf_percentage, stem_percentage, root_percentage, starch_percentage, seed_percentage, water_in, nitrate_in, starch_in, photon_in, leaf_mass, stem_mass,root_mass, seed_mass,
                         water_pool, starch_pool, nitrate_pool, leaf_rate, stem_rate, root_rate, seed_rate):
        self.model_writer.writerow(
            [days, hours, minutes, leaf_percentage, stem_percentage, root_percentage, starch_percentage, seed_percentage, water_in, nitrate_in, starch_in, photon_in, leaf_mass, stem_mass, root_mass, seed_mass, water_pool,
