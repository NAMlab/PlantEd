...
from PlantEd_Server.client.gameobjects.plant import Plant, Organ
from PlantEd_Server.client.utils.gametime import GameTime
from PlantEd_Server.client.utils.particle import ParticleSystem, Inwards_Particle_System
from PlantEd_Server.client.utils.narrator import Narrator
from PlantEd_Server.client.utils.hover_message import Hover_Message
from PlantEd_Server.data import assets
from PlantEd_Server.client.utils.button import (
    RadioButton,
    ToggleButton,
    Slider,
    SliderGroup,
...
class UI:
    ...
    def draw_clock(self, s):
        ...
        temperature_label = config.FONT.render("{:.0f} °C".format(self.temperature), True, config.BLACK)
