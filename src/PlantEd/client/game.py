...
class EndScene(object):
    def __init__(self, path_to_logs):
        ...
        self.plant_object: Plant = Plant.from_dict(
            dict_plant,
            self.camera)
        positions = []
        ...
        self.score_sum_label = self.asset_handler.FONT_36.render("{:.2f} grams".format(float(score_sum)), True,
                                                                 config.WHITE)
