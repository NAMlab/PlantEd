...
class Shop:
    def __init__(self, rect, shop_items, client: Client, water_grid: Water_Grid, plant, cols=2, margin=10, post_hover_message=None, active=True):
        ...
        self.buy_button = Button(self.rect[2] - self.margin * 2 - 64, self.rect[3] - self.margin - 64, 64, 64, [self.buy],
                                 config.FONT, "BUY", offset=(rect[0], rect[1]))
        self.init_layout()
